...
@WebServlet(name = "criacaouser2", urlPatterns = {"/CriacaoUser2"})
public class CriacaoUser2 extends HttpServlet {


    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("/WEB-INF/criacao_user2.jsp").forward(request, response);
    }
